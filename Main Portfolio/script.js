...
function populateProjects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      buttons: [
        { label: 'View Project', url: '../Learning/intro.html' }
      ]
    }
  ];
  ...
  function sendTerminalContact() {
    ...
    function trySend() {
      ...
      Promise.all([
        ...
        emailjs.send('service_ou9wrhm', 'template_emj3218', { to_name: name, name, from_email: email, to_email: email, email, message, time })
      ])
      .then(() => done(true))
      .catch(() => done(false));
    }
